...
const help = new Discord.MessageEmbed()
            ...
            .setDescription("● :exclamation: Le bot n'est pas encore fini, il y a quelques commandes qui ne marchent pas encore.\n ● Mon préfix est `.`\n ● Je possède un total de `63` commandes")
            .addField("<:general:774824803186114560> __Général__", "`help`, `invite`, `embed`,  `img`,  `ui`, `serv-info`, `sondage`, `about`,`ascii`, `reversetext`, `pp`, `fortnite`, `rdm-number`, `invite`")
            .addField("<:moderation:774826227184828437> __Modération__", "`ban`, `kick`, `tempban`,`clear`, `unban`, `mute`, `unmute`, `tempmute`, `slowmode`")
            .addField("<:fun:774824901877956640> __Divertissement__ ", "`anonymous`, `fbi`, `poutine`, `trump`, `macron`, `cheh`, `meme`, `coinflip`, `issou`, `covid`, `8ball`, `nitro`, `panda`, `koala`, `fox`, `cat`, `dog`, `captcha`, `fortnite-shop`, `hastbin`, `weather`, `createinvite`, `covid-stats`")
            .addField("<:nsfw:774825055921111081> __NSFW__ ", "`hentai`, `boobs`, `hentai2`, `waifu`, `ass`, `wallpaper`")
            .addField("<:owner:774825209936478249> __Owner__", "`serverlist`, `maj`")   
